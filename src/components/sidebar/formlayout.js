  ...
  return (
    <div className="flex h-screen bg-gray-100">
      ...
      <div className="flex-1 relative h-full p-8">
        {/* Page Header */}
        <div className="mb-8">
          <h1 className="text-2xl font-bold">Form Layouts</h1>
          <p className="text-sm text-gray-500">Home | Forms | Layouts</p>
        </div>
        ...
        <div className="flex flex-wrap gap-4">
          ...
          <div className="bg-white p-6 rounded-lg shadow flex-1 min-w-[300px]">
            <h2 className="text-lg font-bold mb-4">Horizontal Form</h2>
          ...
          <div className="bg-white p-6 rounded-lg shadow flex-1 min-w-[300px]">
            <h2 className="text-lg font-bold mb-4">Vertical Form</h2>
            <div className="space-y-4">
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-2">
                  Switches
          ...
          <div className="bg-white p-6 rounded-lg shadow flex-1 min-w-[300px]">
            <h2 className="text-lg font-bold mb-4">Multi Columns Form</h2>
            <div className="space-y-4">
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-2">
                  Dropdown
