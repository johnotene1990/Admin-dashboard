...
const ApexChartsDisplay = () => {
  return (
    ...
    <div className="flex-1 relative h-full p-8  bg-gray-100 min-h-screen">
      {/* Page Header */}
      <div className="mb-8">
        <h1 className="text-2xl font-bold mb-2">ApexCharts</h1>
        <p className="text-sm text-gray-500">Home | Charts | ApexCharts</p>
...
export default ApexChartsDisplay;
